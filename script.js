document.addEventListener('DOMContentLoaded', () => {
  let questions = [
    ...
    {
        "question": "Which city is famous for the 'Gateway of India' monument?",
        "options": [
            "Kolkata",
            "Chennai",
            "Mumbai",
    ...
    {
        "question": "Which Indian city is home to the Indian Institute of Science (IISc)?",
        "options": [
            "Bengaluru",
            "Chennai",
            "Mumbai",
    ...
    {
        "question": "Which Indian state is known as the 'Land of Five Elements'?",
        "options": [
            "Gujarat",
            "Tamil Nadu",
            "Karnataka",
  ...
  const selectOption = document.getElementById("difficulty-select");
  ...
  startBtn.addEventListener("click", () => {
    const difficulty = selectOption.value;
    if (!difficulty) {
      alert("Please select a difficulty level!");
      return;
    }
    selectedQuestions = questions.filter(q => q.difficulty === difficulty);
  ...
  restartBtn.addEventListener("click", () => {
    ...
    container.innerHTML = `<div class="left">
      <div id="image-container">
        <img src="assets/wise_owl.png" alt="Wise Owl Mascot">
      </div>
    </div>
    <div class="right">
  ...
  function loadQuestion() {
    ...
    questionNumber.innerText = `Question ${currentQuestionIndex + 1} of ${selectedQuestions.length}`;

    currentQ.options.forEach(option => {
      const btn = document.createElement("button");
      btn.innerText = option;
      btn.classList.add("option-btn");
      btn.addEventListener("click", () => selectAnswer(btn, currentQ.correctAnswer));
  ...
  function showResult() {
    ...
    scoreText.innerText = `You scored ${score} out of ${selectedQuestions.length}`;
  }
});
